...
$OutRoot = Join-Path $Root "runs\bvr\same_protocol_medium_2seed_gate_20260620"
...
Write-Host ("All BVR same-protocol medium 2-seed experiments finished: {0}" -f $OutRoot)
