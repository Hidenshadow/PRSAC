...
$OutRoot = Join-Path $Root "runs\sac_modified\ldac_v2_hard_seed0_1_20260621"
...
$Experiments = @(
    @{ Level = "level1_hard"; Config = "configs\levels\ppo_difficulty\level1_hard.json"; EvalEpisodes = 300 },
    @{ Level = "level2_hard"; Config = "configs\levels\ppo_difficulty\level2_hard.json"; EvalEpisodes = 128 },
    @{ Level = "level3_hard"; Config = "configs\levels\ppo_difficulty\level3_hard.json"; EvalEpisodes = 128 }
)
...
Write-Host ("All LDAC-SAC v2 hard seed0/1 experiments finished: {0}" -f $OutRoot)
